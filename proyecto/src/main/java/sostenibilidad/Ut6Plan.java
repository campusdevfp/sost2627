...
public class Ut6Plan {
    ...
    /**
     * Método 1. Estrategia con un grupo de interés según la matriz de poder e interés:
    ...
    /**
     * Método 2. Doble materialidad: un aspecto es material si su impacto O su
    ...
    /**
     * Método 3. Tipo de materialidad: "AMBAS", "IMPACTO", "FINANCIERA" o "NO MATERIAL".
     */
    ...
    /**
     * Método 4. Prioridad de un aspecto, redondeada a 1 decimal:
    ...
    /**
     * Método 5. Progreso de una acción, entre 0.0 y 1.0 y redondeado a 2 decimales:
    ...
    /**
     * Método 6. Estado de una acción según su progreso:
    ...
    /**
     * Método 7. Indica si una acción va en plazo: su progreso es al menos la
    ...
    /**
     * Método 8. Nombres de los aspectos que no tienen ninguna acción, en el mismo orden
