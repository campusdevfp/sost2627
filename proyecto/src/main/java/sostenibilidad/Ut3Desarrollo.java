...
public class Ut3Desarrollo {
    ...
    /**
     * Método 1. Indica si merece la pena comprimir un tipo de contenido.
    ...
    /**
     * Método 2. Segundos de max-age de una cabecera Cache-Control.
    ...
    /**
     * Método 3. Puntuación de sostenibilidad de un recurso, de 0 a 100.
    ...
    /** Método 4. Suma de los bytes de todos los recursos de una página. */
    ...
    /**
     * Método 5. Porcentaje de bytes ahorrado al comprimir, redondeado a 1 decimal.
    ...
    /**
     * Método 6. Kg de CO2 al año de ir y volver al trabajo, redondeados a 1 decimal.
    ...
    /**
     * Método 7. Kg de CO2 que se ahorran al año cambiando de medio de transporte
    ...
    /**
     * Método 8. Etiqueta del peso de una página:
