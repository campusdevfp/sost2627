...
class Ut3DesarrolloTest {
    ...
    @Test
    @DisplayName("M1 · un tipo nulo no es comprimible")
    void tipoNulo() {
        assertFalse(Ut3Desarrollo.esComprimible(null));
    }

    @Test
    @DisplayName("M2 · lee el max-age de Cache-Control")
    void maxAge() {
    ...
    @Test
    @DisplayName("M3 · puntuación de un recurso bien servido")
    void recursoBueno() {
        assertEquals(100, Ut3Desarrollo.puntuacionRecurso("text/css", 12_000, true, UN_ANIO));
    }

    @Test
    @DisplayName("M3 · puntuación con hallazgos")
    ...
    @Test
    @DisplayName("M4 · peso total de la página")
    void pesoTotal() {
    ...
    @Test
    @DisplayName("M5 · reducción porcentual al comprimir")
    void reduccion() {
    ...
    @Test
    @DisplayName("M6 · huella anual del desplazamiento")
    void desplazamiento() {
    ...
    @Test
    @DisplayName("M6 · medio desconocido o datos negativos lanzan excepción")
    ...
    @Test
    @DisplayName("M7 · ahorro al cambiar de transporte")
    void ahorroCambio() {
    ...
    @ParameterizedTest(name = "M8 · {0} bytes -> {1}")
