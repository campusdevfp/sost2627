...
public class Ut5Huella {
    ...
    /** Ejercicio 1. kWh necesarios para transferir esos bytes (sin redondear). */
    ...
    /**
     * Ejercicio 2. Gramos de CO2 de transferir esos bytes con una intensidad de red
    ...
    /**
     * Ejercicio 3. Kg de CO2 al año de un endpoint, redondeados a 1 decimal:
    ...
    /**
     * Ejercicio 4. SCI (Software Carbon Intensity): (energia x intensidad + embebido) / unidades.
    ...
    /**
     * Ejercicio 5. Porcentaje de reducción entre una medida antes y después,
    ...
    /**
     * Ejercicio 6. Sospecha del problema N+1: hay al menos 2 elementos y el número de
    ...
    /**
     * Ejercicio 7. Hora del día (posición en el array, de 0 a 23) con menor intensidad
    ...
    /**
     * Ejercicio 8. Etiqueta energética de una petición según sus gramos de CO2:
