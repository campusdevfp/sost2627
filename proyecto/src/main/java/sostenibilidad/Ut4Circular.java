...
public class Ut4Circular {
    ...
    /**
     * Método 1. Indica si se puede pasar de un estado a otro:
    ...
    /**
     * Método 2. Comprueba una transición y, si no está permitida, lanza
    ...
    /**
     * Método 3. Huella anual de un equipo en kg de CO2, redondeada a 1 decimal:
    ...
    /**
     * Método 4. Kg de CO2 al año que se ahorran alargando la vida del equipo,
    ...
    /**
     * Método 5. Porcentaje del total del ciclo de vida que corresponde a la fabricación,
    ...
    /**
     * Método 6. Mejor opción de la jerarquía de las R entre las viables:
    ...
    /**
     * Método 7. Tasa de circularidad, redondeada a 1 decimal:
    ...
    /**
     * Método 8. Años que tarda en amortizarse la fabricación de un equipo nuevo
