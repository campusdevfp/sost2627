...
public class Ut1Asg {
    ...
    /**
     * Ejercicio 1. Clasifica un tema en su dimensión ASG.
    ...
    /**
     * Ejercicio 2. Grado de cumplimiento de un indicador, entre 0.0 y 1.0.
     * Si mayorEsMejor: valor / meta, con tope 1.0 (si meta es 0, devuelve 1.0).
    ...
    /**
     * Ejercicio 3. Semáforo del indicador a partir de su cumplimiento (0.0 a 1.0):
    ...
    /**
     * Ejercicio 4. Puntuación de una dimensión, de 0 a 100: media de los cumplimientos
    ...
    /**
     * Ejercicio 5. Puntuación ASG global: ambiental x 0.4 + social x 0.3 + gobernanza x 0.3,
    ...
    /**
     * Ejercicio 6. Rating a partir de la puntuación (0 a 100):
    ...
    /**
     * Ejercicio 7. Indica si un indicador ha mejorado respecto al año anterior,
    ...
    /**
     * Ejercicio 8. Números de ODS válidos (1 a 17), ordenados de menor a mayor y sin repetir.
