...
class Ut1AsgTest {
    ...
    @Test
    @DisplayName("M1 · clasifica temas en su dimensión ASG")
    void clasifica() {
    ...
    @Test
    @DisplayName("M2 · cumplimiento cuando mayor es mejor")
    ...
    @Test
    @DisplayName("M2 · cumplimiento cuando menor es mejor")
    ...
    @ParameterizedTest(name = "M3 · cumplimiento {0} -> {1}")
    ...
    @Test
    @DisplayName("M3 · cumplimiento fuera de rango lanza excepción")
    ...
    @Test
    @DisplayName("M4 · puntuación de una dimensión")
    ...
    @Test
    @DisplayName("M5 · puntuación ASG ponderada")
    void puntuacionAsg() {
    ...
    @Test
    @DisplayName("M6 · puntuación fuera de rango lanza excepción")
    ...
    @Test
    @DisplayName("M7 · detecta si el indicador ha mejorado")
    void haMejorado() {
    ...
    @Test
    @DisplayName("M8 · ODS ordenados, sin repetir y sin inválidos")
    void odsCubiertos() {
